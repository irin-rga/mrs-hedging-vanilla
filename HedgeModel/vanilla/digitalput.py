from  HedgeModel.vanilla.blackscholes import BSDigitalPut
...
class DigitalPut(Vanilla):
    ...
    def calc(self, s: float, r: float, q: float, vol: float, t: float, calctype: CalcType = CalcType.Price):
        ...
        # Calc the result
        result_per_contract = self.position_mult * BSDigitalPut(s, self.strike, r, q, vol, t, self.payoff_per_contract, str(calctype))
